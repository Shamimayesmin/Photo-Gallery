...
const SingleImage = ({
	...
	return (
		<div>
			<div key={index} draggable={true} onDrop={()=>handleDrop(index)} onDragStart={()=>handleDragStart(item)} className="card card-compact w-80 relative shadow-lg bg-white rounded-md hover:brightness-50 border-4 border-slate-600">
